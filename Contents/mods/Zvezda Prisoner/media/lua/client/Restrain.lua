...
function Restrain.stopSurrender(player)
    if Restrain.isSurrendering(player) and not player:getModData().isRestrained then
        ...
        playerdataClient.updatePlayer(player:getDisplayName(), "isSurrendering", false);
        playerdataClient.updatePlayer(player:getDisplayName(), "inventary", nil);
...
function Restrain.doSurrender(player)
    if not Restrain.isSurrendering(player) then
        ...
        playerdataClient.updatePlayer(player:getDisplayName(), "isSurrendering", true);
