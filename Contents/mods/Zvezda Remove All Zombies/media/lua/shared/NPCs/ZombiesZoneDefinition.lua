...
table.insert(ZombiesZoneDefinition.Default,{name = "Generic01", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Generic02", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Generic03", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Generic_Skirt", gender="female", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Generic04", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Generic05", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Biker", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Cyclist", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "DressLong", chance=0, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "DressNormal", chance=0, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "DressShort", chance=0, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "Golfer", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Young", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "OfficeWorker", chance=0, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "OfficeWorkerSkirt", chance=0, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "Police", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "PoliceState", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Ranger", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "ConstructionWorker", chance=0, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "Farmer", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Student", chance=0});
table.insert(ZombiesZoneDefinition.Default,{name = "Foreman", chance=0, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "Bathrobe", chance=0, room="bathroom"});
table.insert(ZombiesZoneDefinition.Default,{name = "Naked", chance=0, room="bathroom"});
table.insert(ZombiesZoneDefinition.Default,{name = "Priest", chance=0, room="church", gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "Bedroom", chance=0, room="bedroom"});
